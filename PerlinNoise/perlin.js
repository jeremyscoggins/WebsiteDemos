//javascript translation of c# simplex noise algorithm
// based on code found at http://code.google.com/p/simplexnoise/
(function(window){
	...
	{
		return (x > 0) ? (parseInt(x)) : ((parseInt(x)) - 1);
	}
